...
app = typer.Typer(help="Curate testing stacks and tooling.")
...
def list_stacks(
    ...
    """List testing stacks."""
    config = get_domain_config(ctx, "testing")
...
def suggest(
    ...
    """Highlight recommended testing stacks."""
    config = get_domain_config(ctx, "testing")
    console: Console = ctx.obj["console"]
    render_stack_table(console, config.get("stacks", {}), stack=stack)
