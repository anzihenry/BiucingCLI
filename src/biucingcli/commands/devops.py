...
app = typer.Typer(help="Curate DevOps stacks and tooling.")
...
def list_stacks(
    ...
    """List DevOps stacks."""
    config = get_domain_config(ctx, "devops")
...
def suggest(
    ...
    """Highlight recommended DevOps stacks."""
    config = get_domain_config(ctx, "devops")
    console: Console = ctx.obj["console"]
    render_stack_table(console, config.get("stacks", {}), stack=stack)
