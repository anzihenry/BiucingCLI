"""Frontend toolchain subcommands."""
...
app = typer.Typer(help="Curate frontend stacks and tooling.")
...
def list_stacks(
    ...
    config = get_domain_config(ctx, "frontend")
...
def suggest(
    ...
    """Highlight recommended frontend stacks."""
    config = get_domain_config(ctx, "frontend")
    console: Console = ctx.obj["console"]
    render_stack_table(console, config.get("stacks", {}), stack=stack)
