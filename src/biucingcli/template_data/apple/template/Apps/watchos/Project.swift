...
let appName = "{{SWIFT_MODULE_NAME}}_watchos"
...
let project = Project(
    ...
    targets: [
        .target(
            ...
            product: .app,
            bundleId: "{{BUNDLE_IDENTIFIER}}.watchos\(debugBundleSuffix)",
            deploymentTargets: .watchOS("{{MINIMUM_OS_VERSION}}"),
            infoPlist: .extendingDefault(with: [
                "WKApplication": true, "WKWatchOnly": true,
        ...
        .target(
            ...
            destinations: [.appleWatch],
            product: .unitTests,
            bundleId: "{{BUNDLE_IDENTIFIER}}.watchos\(debugBundleSuffix).tests",
            deploymentTargets: .watchOS("{{MINIMUM_OS_VERSION}}"),
            infoPlist: .default,
            sources: ["Tests/**"],
