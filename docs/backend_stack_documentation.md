...
#### 数据库驱动
- **go-sql-driver/mysql (v1.8.0+)**: MySQL 数据库驱动
- **jackc/pgx (v5.6.0+)**: PostgreSQL 数据库驱动
...
#### JWT-Go (v5.2.0+)
- **版本**: v5.2.0+ (github.com/golang-jwt/jwt/v5)
- **Go 版本要求**: Go 1.21+
...
#### OAuth2 (v0.18.0+)
- **版本**: v0.18.0+ (golang.org/x/oauth2)
- **作用**: OAuth2 协议实现
- **使用场景**:
...
#### Bcrypt (v0.0.0-20221205205833-457c7dc9a182+)
- **版本**: v0.0.0-20221205205833-457c7dc9a182+ (golang.org/x/crypto/bcrypt)
- **作用**: 密码哈希函数
- **使用场景**:
  - 密码哈希存储
  - 敏感数据加密
...
#### pkg/errors (v0.9.1+)
- **版本**: v0.9.1+
- **注意**: Go 1.21+ 已内置错误包装功能，但 pkg/errors 仍广泛使用
- **作用**: Go 错误处理增强
- **安装命令**:
  ```bash
...
#### Validator (v10.20.0+)
- **版本**: v10.20.0+ (github.com/go-playground/validator/v10)
- **Go 版本要求**: Go 1.21+
- **作用**: Go 结构体和字段验证库
- **使用场景**:
  - 请求参数验证
...
#### NATS (v1.34.0+)
- **版本**: v1.34.0+ (github.com/nats-io/nats.go)
- **Go 版本要求**: Go 1.21+
- **作用**: 高性能消息系统
- **使用场景**:
  - 微服务间通信
